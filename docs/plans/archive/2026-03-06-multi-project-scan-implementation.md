...
```bash
cd packages/veriresume-cli && npm install @inquirer/prompts
```
...
**Files:**
- Modify: `packages/veriresume-cli/src/types/manifest.ts`
...
**Files:**
- Modify: `packages/veriresume-cli/src/core/prompt.ts`

**Step 1: Add the checkbox function**

Append to the end of `packages/veriresume-cli/src/core/prompt.ts`:
...
**Files:**
- Create: `packages/veriresume-cli/src/core/identity.ts`
- Create: `packages/veriresume-cli/src/core/identity.test.ts`
...
```bash
cd packages/veriresume-cli && npm test 2>&1 | grep -E "(identity|FAIL|Error)"
```
...
```bash
cd packages/veriresume-cli && npm test 2>&1 | grep -E "(identity|FAIL|PASS)"
```
...
```bash
git add packages/veriresume-cli/src/core/identity.ts packages/veriresume-cli/src/core/identity.test.ts
...
**Files:**
- Create: `packages/veriresume-cli/src/core/github.ts`
- Create: `packages/veriresume-cli/src/core/github.test.ts`
...
```bash
cd packages/veriresume-cli && npm test 2>&1 | grep -E "(github|FAIL|Error)"
```
...
```bash
cd packages/veriresume-cli && npm test 2>&1 | grep -E "(github|FAIL|PASS)"
```
...
```bash
git add packages/veriresume-cli/src/core/github.ts packages/veriresume-cli/src/core/github.test.ts
...
**Files:**
- Create: `packages/veriresume-cli/src/core/merge.ts`
- Create: `packages/veriresume-cli/src/core/merge.test.ts`
...
```bash
cd packages/veriresume-cli && npm test 2>&1 | grep -E "(merge|FAIL|Error)"
```
...
```bash
cd packages/veriresume-cli && npm test 2>&1 | grep -E "(merge|FAIL|PASS)"
```
...
```bash
git add packages/veriresume-cli/src/core/merge.ts packages/veriresume-cli/src/core/merge.test.ts
...
**Files:**
- Modify: `packages/veriresume-cli/src/commands/scan.ts`
...
```bash
git add packages/veriresume-cli/src/commands/scan.ts
...
**Files:**
- Create: `packages/veriresume-cli/src/commands/scan-multi.ts`
...
```bash
git add packages/veriresume-cli/src/commands/scan-multi.ts
...
```bash
cd packages/veriresume-cli && npm run build && node dist/index.js scan-multi --help
```
