...
**Files:**
- Modify: `packages/veriresume-cli/src/types/manifest.ts:1`
...
**Files:**
- Modify: `packages/veriresume-cli/src/core/git.ts`
- Modify: `packages/veriresume-cli/src/core/git.test.ts`
...
Run: `cd packages/veriresume-cli && npm test 2>&1 | tail -20`
...
**Files:**
- Modify: `packages/veriresume-cli/src/core/evidence.ts`
- Modify: `packages/veriresume-cli/src/core/evidence.test.ts`
...
- Modify: `packages/veriresume-cli/src/commands/scan.test.ts`
...
**Files:**
- Modify: `packages/veriresume-cli/src/core/skills.ts`
- Modify: `packages/veriresume-cli/src/core/skills.test.ts`
...
**Files:**
- Modify: `packages/veriresume-cli/src/commands/integration.test.ts`
...
Run: `cd packages/veriresume-cli && npm test 2>&1`
Expected: All tests PASS
